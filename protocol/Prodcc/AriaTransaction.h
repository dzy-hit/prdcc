...
public:
  ...
  /**
   * @brief Extracts the read and write sets of the transaction as ranges of uint64_t keys.
   *        For point queries, a range is represented as [key, key].
   * 
   * @param read_ranges Vector to be filled with read key ranges.
   * @param write_ranges Vector to be filled with write key ranges.
   */
