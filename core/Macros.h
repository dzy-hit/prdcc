...
DEFINE_bool(enable_timer, false,
            "Enable protocol phase timing (Aria: execution vs abort/retry; "
            "Prodcc: prediction vs schedule+execution).");
...
#define SETUP_CONTEXT(context)                                                 \
  ...
  context.enable_timer = FLAGS_enable_timer;                                   \
